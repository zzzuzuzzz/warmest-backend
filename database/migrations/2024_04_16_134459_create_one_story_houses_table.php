...
return new class extends Migration
{
    ...
    {
        Schema::create('one_story_houses', function (Blueprint $table) {
...
//----------Поля с фотографиями проекта--------------------------
            ...
            $table->string('second_floor_img')->nullable();
...
//----------Поля с дополнительной информацией (1 этаж)------------
            ...
            $table->text('porch_and_terrace')->nullable();
            $table->text('wind_proofing_the_wall')->nullable();
            $table->text('external_wall_frame')->nullable();
            $table->text('exterior_finishing')->nullable();
            $table->text('interior_decoration')->nullable();
            $table->text('insulation_of_external_walls')->nullable();
            $table->text('partitions')->nullable();
            $table->text('insulation_of_partitions')->nullable();
            $table->text('ceilings')->nullable();
            $table->text('floors')->nullable();
            $table->text('floor_insulation')->nullable();
            $table->text('inter_floor_ceiling')->nullable();
...
//----------Служебная информация--------------------------------------
    ...
    {
        Schema::dropIfExists('one_story_houses');
    }
};
